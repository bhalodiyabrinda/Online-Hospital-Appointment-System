...
$column1_value = ""; // Initialize $column1_value with an empty string

// Execute SELECT query to retrieve data
$sql = $con->prepare("SELECT * FROM register WHERE email = ?");
...
<body>
    ...
    <section id="hero">
        ...
        <nav class="navigation">
            ...
            <form action="formlogout.php" method="post">
            <ul>
                <!-- <li><a href="index.php" class="nav-appointment-btn" style="margin-right:80px;">Log Out</a></li> -->
                <li><button type="submit" name="btnlgout" class="nav-appointment-btn" style="margin-right:80px;">Log Out                     <?php echo $_SESSION["username"];?>
 </button></li>
            </ul>
            </form>
            <div>
    ...
    <a href="edituser.php" target="_blank" >
        <?php echo '<img class="rounded-image" src="' . $column2_value . '" alt="" width="80px">';?>
    </a>
</div>
                ...
                <div class="hero-text-btns">
                    <a href="#">
                        <form action="Rate.php" method="POST">
                            ...
                            <button name="r" class="btn text-light">Review</button>
                        </form>
                    </a>
                    <a href="bookapp.php">
                        <i class="fa-solid fa-check"></i>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="team-box">
                        ...
                        <div class="team-img">
                            <a href="about_doctor.php"><img src="photo/d1.png" alt=""></a>
                        </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="team-box">
                        ...
                        <div class="team-img">
                            <a href="about_doctor.php"><img src="photo/d5.png" alt=""></a>
                        </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="team-box">
                        ...
                        <div class="team-img">
                            <a href="about_doctor.php"><img src="photo/d2.png" alt=""></a>
                        </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="team-box">
                        ...
                        <div class="team-img">
                            <a href="about_doctor.php"><img src="photo/d3.png" alt=""></a>
                        </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="team-box">
                        ...
                        <div class="team-img">
                            <a href="about_doctor.php"><img src="photo/d4.png" alt=""></a>
                        </div>
